# WAP THAT HAS A CLASS STORE WHICH KEEPS A RECORD OF CODE (ITEM KA )AND PRICE OF PRODUCT. 
# DISPLAY A MENU OF ALL PRODUCTS TO THE USER AND PROMPT HIM TO ENTER THE QUANTITY OF EACH ITEM REQUIRED AND FINALLY GENERATE A BILL AND DISPLAY TOTAL AMOUNT
# PRICE AND CODE SHOUD BE PRIVATE
